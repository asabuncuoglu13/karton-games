const _levels = [
    "Level 1: <a href='javascript:showNextLevelExplanation(0)'>⏭️Next ⏭️</a><br> Every game needs some player input. In this game, players click on the screen to make the Dino jump. Code this behaviour",
    "Level 2: <a href='javascript:showNextLevelExplanation(1)'>⏭️Next ⏭️</a> <br> What is the challenge of your game? When will the game end? Let's code what happens when the Dino hits to cactus",
    "Level 3: <a href='javascript:showNextLevelExplanation(2)'>⏭️Next ⏭️</a> <br> Now, we have already coded some basic functions of the game. Now, add some cacti as obstacles and get the Dino run",
...
const _title = "Program the Dino Game";
const _explanation = "Show the programming cards to camera and start coding! <a href='./codelab/tr/index.html'>If you need a guide, visit our tutorial.</a>";
